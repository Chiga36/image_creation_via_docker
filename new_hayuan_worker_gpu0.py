...
UNET_MODEL = os.environ.get("UNET_MODEL", "hunyuanimage2.1-distilled-v2-q3_k_m.gguf")
CLIP1_MODEL = os.environ.get("CLIP1_MODEL", "qwen2.5-vl-7b-test-q4_0.gguf")
CLIP2_MODEL = os.environ.get("CLIP2_MODEL", "byt5_small_glyphxl_fp32-iq4_nl.gguf")
VAE_MODEL = os.environ.get("VAE_MODEL", "pig_hunyuan_image_vae_fp32-f16.gguf")

# Full paths for verification
UNET_MODEL_FULL_PATH = os.environ.get("UNET_MODEL_FULL_PATH", "/home/comfyuser/ComfyUI/models/unet/hunyuanimage2.1-distilled-v2-q3_k_m.gguf")
CLIP1_MODEL_FULL_PATH = os.environ.get("CLIP1_MODEL_FULL_PATH", "/home/comfyuser/ComfyUI/models/clip/qwen2.5-vl-7b-test-q4_0.gguf")
CLIP2_MODEL_FULL_PATH = os.environ.get("CLIP2_MODEL_FULL_PATH", "/home/comfyuser/ComfyUI/models/clip/byt5_small_glyphxl_fp32-iq4_nl.gguf")
VAE_MODEL_FULL_PATH = os.environ.get("VAE_MODEL_FULL_PATH", "/home/comfyuser/ComfyUI/models/vae/pig_hunyuan_image_vae_fp32-f16.gguf")
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(os.path.join(log_dir, 'hunyuan_worker_gpu0.log')),
...
def verify_paths():
    ...
    logger.info(f"CLIP1 Model: {CLIP1_MODEL}")
    logger.info(f"CLIP2 Model: {CLIP2_MODEL}")
    ...
    model_files = {
        ...
        "CLIP1": CLIP1_MODEL_FULL_PATH,
        "CLIP2": CLIP2_MODEL_FULL_PATH,
...
def load_api_keys() -> set:
    ...
    default_keys = {"master_key_123","hayuan_key_456"}
...
async def load_models():
    """Load all ComfyUI models and nodes for HunyuanImage"""
    ...
    try:
        logger.info("Loading HunyuanImage models on GPU 0...")
        cleanup_gpu_memory()
        ...
        logger.info("HunyuanImage models loaded successfully on GPU 0")
        models_loaded = True
                ...
                with job_lock:
                    if job_queue:
                        ...
                        if job_id in active_jobs:
                            ...
                            asyncio.create_task(process_image_generation_job(job_id, job_data["request"]))
...
async def process_image_generation_job(job_id: str, request: ImageGenerationRequest):
    ...
    try:
        await asyncio.wait_for(
            loop.run_in_executor(
                generation_executor,
                process_image_generation_job_sync,
                job_id,
                request
            ),
            timeout=JOB_TIMEOUT
    ...
    for attempt in range(max_attempts):
        try:
            ...
            with torch.inference_mode():
                ...
                # Load UNET model
                unetloadergguf_30 = unetloadergguf.load_unet(unet_name=UNET_MODEL)

                # Load dual CLIP
                
                dualcliploadergguf_31 = dualcliploadergguf.load_clip(
                ...
                # Load VAE
                vaeloader_32 = vaeloader.load_vae(vae_name=VAE_MODEL)

                # Create empty latent
                emptysd3latentimage_29 = emptysd3latentimage.generate(
                    width=request.width,
                ...
                cliptextencode_6 = cliptextencode.encode(
                    text=request.prompt,
                    clip=get_value_at_index(dualcliploadergguf_31, 0),
                )
                ...
                ksampler_3 = ksampler.sample(
                    ...
                    scheduler="simple",
                    denoise=1,
                    model=get_value_at_index(unetloadergguf_30, 0),
                    positive=get_value_at_index(cliptextencode_6, 0),
                    negative=get_value_at_index(cliptextencode_7, 0),
                    latent_image=get_value_at_index(emptysd3latentimage_29, 0),
                )
                ...
                filename_prefix = f"gpu0_{timestamp}_HUNYUAN_{job_id[:8]}"
...
async def lifespan(app: FastAPI):
    ...
    logger.info("Shutting down HunyuanImage worker...")
...
app = FastAPI(
    title="Self-Managing HunyuanImage Generation Worker",
    description="HunyuanImage generation with built-in job queue and load management",
    version="2.0.0",
    lifespan=lifespan
)
...
async def get_statistics():
    ...
    return {
        "service_info": {
            "name": "Self-Managing HunyuanImage Worker",
            "version": "2.0.0",
            "gpu_id": CUDA_DEVICE,
...
async def health_check():
    ...
    return {
        ...
        "gpu_id": CUDA_DEVICE,
        "service": "hunyuan_image_generation_self_managing",
        "models_loaded": models_loaded,
        "current_load": current_load,
        "gpu_memory": gpu_memory,
        "cpu_usage": f"{cpu_percent}%",
...
async def generate_api_key(request: dict):
    ...
    new_key = f"hunyuan_key_{uuid.uuid4().hex[:16]}"
    ...
    return {
        "api_key": new_key,
        "email": email,
        "service": "hunyuan_image_generation",
...
async def root():
    ...
    return {
        "service": "Self-Managing HunyuanImage Generation Worker",
        "version": "2.0.0",
        "gpu_id": CUDA_DEVICE,
