...
UNET_HIGH_NOISE = os.environ.get("UNET_HIGH_NOISE", "Wan2.2-I2V-A14B-HighNoise-Q3_K_M.gguf")
UNET_LOW_NOISE = os.environ.get("UNET_LOW_NOISE", "Wan2.2-I2V-A14B-LowNoise-Q3_K_M.gguf")
